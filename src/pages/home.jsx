...
export default function Home() {
    return (
        <div id={"container"} className="flex flex-col">
            ...
            <div className={"flex flex-row w-full gap-8 mb-6 px-6"}>
                <div className={"flex flex-col w-fit gap-8"}>
                    <div className={"flex flex-row gap-4"}>
                        ...
                        <img src={"/src/assets/homepage/battle.png"} width={512} alt={"article preview image"} className={"border-2 border-blue-600 my-2 rounded-xl"} />
                    </div>
                ...
                <div className={"w-[40%] flex flex-col self-center rounded-xl items-end gap-2 sticky! top-1 mb-auto"}>
                    <h2>Our discord server:</h2>
                    <iframe src="https://discord.com/widget?id=795676694161784922&theme=dark" width="350" height="500"
